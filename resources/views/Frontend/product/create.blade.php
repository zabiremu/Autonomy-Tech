                        ...
                        <div class="card-body">
                            <form action="{{ route('products.store') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @enderror" id="attributes_id" name="attributes_id">
                                        ...
                                        @forelse($attributes as $att)
                                            <option value="{{$att->id}}">{{$att->attributes_name}}</option>
                                        @empty
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @enderror" id="product_price" name="product_price">
                                    @error('product_price')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="Checkbox" id="product_status" name="product_status"  value="0">
                                </div>
